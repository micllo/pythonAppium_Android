...
class ParaCase(unittest.TestCase):
    ...
    def __init__(self, pro_name, test_method="test_", driver=None):
        """
        :param pro_name:
        :param test_method:
        :param driver:
    ...
    @staticmethod
    def get_online_case_to_suite(pro_name, driver=None):
        """
        ...
        for test_class in test_class_list:
            ...
            for test_method_name in test_methods_name:
                if test_method_name in on_line_test_method_name_list:  # 匹配'测试方法'名称
                    test_instance = test_class(pro_name=pro_name, test_method=test_method_name, driver=driver)
